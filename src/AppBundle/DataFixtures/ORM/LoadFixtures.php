...
class LoadFixtures implements FixtureInterface, ContainerAwareInterface
{
    ...
    private function loadUsers(ObjectManager $manager)
    {
        ...
        $encodedPassword = $passwordEncoder->encodePassword($entity, 'user');
	    ...
	    $encodedPassword = $passwordEncoder->encodePassword($entity, 'admin');
	    $entity->setPassword($encodedPassword);
	    $entity->setEnabled(true);
	    $manager->persist($entity);
	    ...
	    $encodedPassword = $passwordEncoder->encodePassword($entity, 'super_admin');
	    $entity->setPassword($encodedPassword);
	    $entity->setEnabled(true);
	    $manager->persist($entity);
    ...
    private function loadPosts(ObjectManager $manager)
    {
        foreach (range(1, 500) as $i) {
            ...
            $post->setSlug($this->container->get('slugger')->slugify($post->getTitle(), $i));
